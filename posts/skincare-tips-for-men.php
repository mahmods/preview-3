...
<div class="contanier">
    <div class="row justify-content-center">
        ...
        <article id="post">
            ...
            <h1>The Enigma Behind Myostatin</h1>
            <span>By Kort Cooper</span>
            <img src="./images/mubariz-mehdizadeh-364026-unsplash.jpg" alt="">
            <div class="content">
                <h2>Dedicated Enigma Myostatin Inhibitor</h2>
                <p>Dedicated have formulated a myostatin inhibitor which is causing a stir called Dedicated Enigma. Although it is an indirect way of myostatin, although the base of the product is the novel extract epicatechin.</p>
                <p>Epicatechin is one of 6 Ingredients. Where I say indirectly, I will quickly break down how the process works.</p>
                <h2>What Does Dedicated Enigma Do?</h2>
                <p>
                ...
                <h2>Dedicated Enigma: Research Backed</h2>
                <p>
